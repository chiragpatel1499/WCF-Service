...
namespace Client.ReminderReferance {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ReminderReferance.IReminder")]
    public interface IReminder {
        ...
        Client.ReminderReferance.ReminderDetail[] getAllReminders(string UserId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReminder/getAllReminders", ReplyAction="http://tempuri.org/IReminder/getAllRemindersResponse")]
        System.Threading.Tasks.Task<Client.ReminderReferance.ReminderDetail[]> getAllRemindersAsync(string UserId);
        ...
        string updateReminder(string UserId, System.DateTime date, string time, string eventType, string desciption, string eventId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReminder/updateReminder", ReplyAction="http://tempuri.org/IReminder/updateReminderResponse")]
        System.Threading.Tasks.Task<string> updateReminderAsync(string UserId, System.DateTime date, string time, string eventType, string desciption, string eventId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IReminderChannel : Client.ReminderReferance.IReminder, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ReminderClient : System.ServiceModel.ClientBase<Client.ReminderReferance.IReminder>, Client.ReminderReferance.IReminder {
        ...
        public Client.ReminderReferance.ReminderDetail[] getAllReminders(string UserId) {
            return base.Channel.getAllReminders(UserId);
        }
        
        public System.Threading.Tasks.Task<Client.ReminderReferance.ReminderDetail[]> getAllRemindersAsync(string UserId) {
        ...
        public string updateReminder(string UserId, System.DateTime date, string time, string eventType, string desciption, string eventId) {
            return base.Channel.updateReminder(UserId, date, time, eventType, desciption, eventId);
        }
        
        public System.Threading.Tasks.Task<string> updateReminderAsync(string UserId, System.DateTime date, string time, string eventType, string desciption, string eventId) {
            return base.Channel.updateReminderAsync(UserId, date, time, eventType, desciption, eventId);
        }
