...
namespace Client
{
    public partial class HomePage : System.Web.UI.Page
    {
        ...
        {
            ReminderReferance.ReminderClient client = new ReminderReferance.ReminderClient("BasicHttpBinding_IReminder");
            List<ReminderReferance.ReminderDetail> data = client.getAllReminders(TextBox1.Text).ToList();
